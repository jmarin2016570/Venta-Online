                    ...
                    if(err){
                        ...
                        product.save((err,productSaved)=>{
                            if(err){
                                ...
                                Categoria.findByIdAndUpdate(categoryId,{$push:{products:productSaved._id}},{new: true},(err,categoryUpdated)=>{
                                    if(err){
    ...
    if(update.stock){
        Producto.findById(productId,(err,productFind)=>{
            if(err){
                ...
                Categoria.findOne({_id:categoryId,products:productId},(err,categoryFind)=>{
                    if(err){
...
function removeProduct(req,res){
    ...
    Categoria.findOneAndUpdate({_id:categoryId,products:productId},{$pull:{products:productId}},{new:true},(err,categoryUpdated)=>{
        if(err){
